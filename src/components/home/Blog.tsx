  ...
  return (
    <div className="p-[50px_20px] lg:p-[80px_80px] flex items-center justify-center">
      <div className="grid gap-[40px] lg:grid-cols-3  2xl:container">
        <div className=" p-[20px_10px] h-[450px] flex flex-col items-start justify-between">
          <div>
        ...
        {Array.from({ length: 2 }).map((_, index) => (
          <div className="h-[450px] border rounded-[10px]" key={index}>
            <div className="h-[250px] w-full border-b"></div>
          </div>
        ))}
      </div>
    </div>
